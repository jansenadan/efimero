...
var _lt = {
	...
	_inyecta: {
		...
		11: {
			...
			7 :'<h2>Está claro</h2><p class="txt-l">Si has llegado a sentir aborrecimiento por causa de los celos</p><p>significa que el daño sufrido por tu amor de pareja es irreparable.</p><div class="consejo"><p>El cuidado, el respeto y la confianza preservan el cariño y el aprecio en la pareja.</p></div>'
		},
		12: {
...
function desli(esto) {
	...
	$('nav#mainNav').removeClass('avi');
	if (_lt._timerAvisa != 0) {
		clearTimeout(_lt._timerAvisa);
	};
	if (dir === 'der') {
		if (pasa && pasa < 316) {
...
function initVert() {
	...
	if (_lt._camino[_lt._actual] === 14 || _lt._camino[_lt._actual] === 16 || _lt._camino[_lt._actual] === 36 || _lt._camino[_lt._actual] === 37) {
		...
		elePage.children('nav').addClass('ani');
...
function avisaFlecha(flag) {
	...
	if(actu > 1 && /*actu != 5 &&*/ actu != 8 && actu != 9 && actu != 11 && actu != 12 && actu != 13 && /*actu != 14 &&*/ actu != 15 && /*actu != 16 &&*/ actu != 18  && actu != 19  && actu != 20  && actu != 21  && actu != 23  && actu != 24  && actu != 25 && actu != 26 && actu != 28 && actu != 29 &&/* actu != 30 &&*/ actu != 31 && actu != 32 && actu != 34 && actu != 35 /* && actu != 36  && actu != 37*/) {
		...
		// $('nav#mainNav').delay(5000).addClass('avi');
	}
